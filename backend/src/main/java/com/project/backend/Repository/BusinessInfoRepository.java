...
public interface BusinessInfoRepository
		extends JpaRepository<BusinessInfo, Long>, JpaSpecificationExecutor<BusinessInfo> {
	Optional<BusinessInfo> findByCountryAndStateAndCityAndAddress(Country country, State state, City city,
			Address address);
