...
function Breadcrumbs() {
  ...
  return (
    <nav aria-label="Breadcrumb" className="flex px- py-4  text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:text-gray-100 dark:border-gray-700">
